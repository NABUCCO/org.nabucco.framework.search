...
/**
 * MaintainServiceHandlerImpl
 * 
 * @author Frank Ratschinski, PRODYNA AG
 */
public class MaintainServiceHandlerImpl extends MaintainServiceHandler {

    private static final long serialVersionUID = 1L;

    @Override
    protected EmptyServiceMessage maintain(OrgMsg msg) throws SearchException {
