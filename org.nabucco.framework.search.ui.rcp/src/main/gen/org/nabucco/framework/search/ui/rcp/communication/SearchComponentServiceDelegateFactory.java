 ...
 */
package org.nabucco.framework.search.ui.rcp.communication;
...
import org.nabucco.framework.search.ui.rcp.communication.fulltext.FulltextIndexDelegate;
import org.nabucco.framework.search.ui.rcp.communication.fulltext.FulltextSearchDelegate;
import org.nabucco.framework.search.ui.rcp.communication.query.MaintainQueryDelegate;
...
public class SearchComponentServiceDelegateFactory extends ServiceDelegateFactorySupport<SearchComponent> {
    ...
    public FulltextIndexDelegate getFulltextIndex() throws ClientException {
        try {
            ...
            throw new ClientException("Cannot connect to component: SearchComponent", e);
